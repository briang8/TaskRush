...
public class PlayerBehavior : MonoBehaviour {
	...
	// Encapsulation: health is private, only modified through DamagePlayer()
	...
	// Called by NPC_Enemy knife/bullet hit
	public void DamagePlayer(){
		...
		if (currentHealth <= 0) {
			...
			GameManager.Instance.TriggerGameOver("You were killed!");
		}
	}
